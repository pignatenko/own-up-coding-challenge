...
function displayErrors(errors) {
  return errors.map((error,idx) => <Alert key={idx} severity="error">{error}</Alert>);
}
...
export function RateQuoteList() {
  ...
  const columns = [
    ...
    {field: 'interestRate', headerName: 'Rate', width: 100, valueFormatter: displayPercentage},
    {field: 'closingCosts', headerName: 'Closing Costs', width: 200, valueFormatter: displayDollarAmount},
    {field: 'monthlyPayment', headerName: 'Monthly Payment', width: 200, valueFormatter: displayDollarAmount},
    {field: 'apr', headerName: 'APR', width: 100, valueFormatter: displayPercentage},
  ];
